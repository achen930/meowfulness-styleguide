...
export default function Graphics() {
	return (
		<div className="space-y-8 px-8 py-12 bg-accent text-primary">
			<Nav />

			<h1 className="text-5xl font-bold text-center underline decoration-tertiary">
				Graphics
			</h1>
			<section>
				<h2 className="text-3xl font-bold underline decoration-tertiary mb-4">
				...
				<div>
					...
					<p>
						...
						accessories, which helps represent a diverse user base. By offering
						these variations, we cater to different preferences and cultural
						representations, ensuring that users see themselves in the mascot
						and feel welcomed.
					</p>
				</div>
				<div>
					...
					<p>
						...
						impariments. Using vector-based icons ensures they remain sharp and
			...
			<section>
				<h2 className="text-2xl font-bold underline decoration-tertiary mb-4">
					Labeling
				</h2>
				<p>
			...
			<section>
				...
				<div>
					...
					<p>
						...
						interactivity. This helps users with cognitive or motor disabilities
						know that an icon is clickable or interactive. For example, applying
						a border or colour change for visual feedback.
					</p>
				</div>
			</section>
			<section>
